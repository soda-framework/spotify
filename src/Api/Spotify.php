...
class Spotify
{
     ...
     *
     * @return array|object The new playlist. Type is controlled by Spotify::setReturnAssoc().
     */
     ...
     *
     * @return array|object The requested album. Type is controlled by Spotify::setReturnAssoc().
     */
     ...
     *
     * @return array|object The requested albums. Type is controlled by Spotify::setReturnAssoc().
     */
     ...
     *                              - string market Optional. An ISO 3166-1 alpha-2 country code, provide this if you wish to apply Track Relinking.
     *
     * @return array|object The requested album tracks. Type is controlled by Spotify::setReturnAssoc().
     */
     ...
     *
     * @return array|object The requested artist. Type is controlled by Spotify::setReturnAssoc().
     */
     ...
     *
     * @return array|object The requested artists. Type is controlled by Spotify::setReturnAssoc().
     */
     ...
     * @param string $artistId ID of the artist.
     *
     * @return array|object The artist's related artists. Type is controlled by Spotify::setReturnAssoc().
     */
     ...
     *
     * @return array|object The artist's albums. Type is controlled by Spotify::setReturnAssoc().
     */
     ...
     *
     * @return array|object The artist's top tracks. Type is controlled by Spotify::setReturnAssoc().
     */
     ...
     *
     * @return array|object The tracks' audio features. Type is controlled by Spotify::setReturnAssoc().
     */
     ...
     *
     * @return array|object The list of categories. Type is controlled by Spotify::setReturnAssoc().
     */
     ...
     *
     * @return array|object The category. Type is controlled by Spotify::setReturnAssoc().
     */
     ...
     *
     * @return array|object The list of playlists. Type is controlled by Spotify::setReturnAssoc().
     */
     ...
     *                              - int offset Optional. Number of playlists to skip.
     *
     * @return array|object The featured playlists. Type is controlled by Spotify::setReturnAssoc().
     */
     ...
     *
     * @return array|object All possible seed genres. Type is controlled by Spotify::setReturnAssoc().
     */
     ...
     *
     * @return array|object The new releases. Type is controlled by Spotify::setReturnAssoc().
     */
     ...
     *                              - int offset Optional. Number of playlists to skip.
     *
     * @return array|object The user's playlists. Type is controlled by Spotify::setReturnAssoc().
     */
     ...
     *                              - string market Optional. An ISO 3166-1 alpha-2 country code, provide this if you wish to apply Track Relinking.
     *
     * @return array|object The user's saved albums. Type is controlled by Spotify::setReturnAssoc().
     */
     ...
     *                              - string market Optional. An ISO 3166-1 alpha-2 country code, provide this if you wish to apply Track Relinking.
     *
     * @return array|object The user's saved tracks. Type is controlled by Spotify::setReturnAssoc().
     */
     ...
     *
     * @return array|object A list with the requested top entity. Type is controlled by Spotify::setReturnAssoc().
     */
     ...
     *
     * @param array $options . Optional. Options for the results.
     *                        - int limit Optional. The maximum number of items to return. Default: 20. Minimum: 1. Maximum: 50.
     *                        - int after Optional. A Unix timestamp in milliseconds. Returns all items after (but not including) this cursor position. If after is specified, before must not be specified.
     *                        - int before Optional. A Unix timestamp in milliseconds. Returns all items before (but not including) this cursor position. If before is specified, after must not be specified.
     *
     * @return array|object A list with the requested top entity. Type is controlled by Spotify::setReturnAssoc().
     */
    public function getRecentlyPlayed($options = []) {
        $headers = $this->authHeaders();
     ...
     *                              - array seed_genres Genres to seed by. Call Spotify::getGenreSeeds() for a complete list.
     *                              - array seed_tracks Track IDs to seed by.
     *                              - mixed target_* Optional. Target value for one of the tunable track attributes.
     *
     * @return array|object The requested recommendations. Type is controlled by Spotify::setReturnAssoc().
     */
     ...
     *                              - string market Optional. An ISO 3166-1 alpha-2 country code, provide this if you wish to apply Track Relinking.
     *
     * @return array|object The requested track. Type is controlled by Spotify::setReturnAssoc().
     */
     ...
     *                               - string market Optional. An ISO 3166-1 alpha-2 country code, provide this if you wish to apply Track Relinking.
     *
     * @return array|object The requested tracks. Type is controlled by Spotify::setReturnAssoc().
     */
     ...
     *
     * @return array|object The requested user. Type is controlled by Spotify::setReturnAssoc().
     */
     ...
     *
     * @return array|object A list of artists. Type is controlled by Spotify::setReturnAssoc().
     */
     ...
     *                                 - string market Optional. An ISO 3166-1 alpha-2 country code, provide this if you wish to apply Track Relinking.
     *
     * @return array|object The user's playlist. Type is controlled by Spotify::setReturnAssoc().
     */
     ...
     *                                 - string market Optional. An ISO 3166-1 alpha-2 country code, provide this if you wish to apply Track Relinking.
     *
     * @return array|object The tracks in the playlist. Type is controlled by Spotify::setReturnAssoc().
     */
     ...
     *                              - int offset Optional. Number of items to skip.
     *
     * @return array|object The search results. Type is controlled by Spotify::setReturnAssoc().
     */
    ...
    /**
     * Add an image to a user's playlist.
     * Requires a valid access token.
     * https://developer.spotify.com/web-api/upload-a-custom-playlist-cover-image/
     *
     * @param string $userId     ID of the user.
     * @param string $playlistId ID of the playlist.
     * @param string $image      Optional. Base64 encoded JPEG image data, maximum payload size is 256 KB
     *
     * @return todo
     */
    public function addUserPlaylistImage($userId, $playlistId, $image)
    {
        $headers = $this->authHeaders();
        ...
        $this->lastResponse = $this->request->api('PUT', $uri, $image, $headers);
